...
public class GenerateValueFiles {
    ...
    //            "1080,1812;1080,1920;1440,2560;1080,2244;1920,1080";
    public static final String SUPPORT_DIMESION = "1920,1080";
...
//        Log.i("testScreen","height高度："+sbForHeight.toString());
        ...
        try {
            layxFile.createNewFile();
            layyFile.createNewFile();
